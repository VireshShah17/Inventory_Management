...
SECRET_KEY = 'django-insecure-jw84bbb&btjjmr=o*7m872gey3v*l7-+js5njbbe^ehx&!8rtf'
...
INSTALLED_APPS = [
    ...
    'order', # Added manually
    'common', # Added manually
    'party', # Added manually
...
# during dev you may want to allow all origins temporarily
